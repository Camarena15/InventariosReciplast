...
?>
<div class="container">
    <h1>Registrar Devolución de Productos <br> de Mantenimiento</h1>
</div>
<br>
<form id="frm">
    <div class="container">
        ...
        <div class="row">
            ...
            <!--<div class="form-group col-2">
                <label for="" class="form-label">Periodo Inicial: </label>
                <input type="date" class="form-control" id="PI">
            </div>
            <div class="form-group col-2">
                <label for="" class="form-label">Periodo Final: </label>
                <input type="date" class="form-control" id="PF">
            </div>
            <div class="form-group col-2">
                <br>
                <button type="button" class="btn btn-danger" onclick="filtrarOrdenInt()">Filtrar</button>
            </div>-->
        </div>
        <div>
            <!--*********************************************************************************************************-->
...
function filtrarOrdenInt(){
    const $select = document.getElementById('IdOrdenInt');
