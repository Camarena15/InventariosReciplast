    ...
    <div class="container">
        <div class="row">
          ...
          ?>
                ...
                <input type="number" class="form-control" readonly onmousedown="return false;" id="IdOrdenInt"
        ...
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <textarea type="text" class="form-control" id="DescripcionMantenimiento" cols="20"
                    rows="5">Escribe aquí la descripción del mantto</textarea>
            </div>
        </div>
        <div class="row">
...
function validarTodo() {
    var idproducto, descu, canti, pre, idorden, descEquipo, descProgra, idprogra, nombre, idempleado, descmantto,
        fecha1, fecha2;
    idproducto = document.getElementById('IdProd').value;
    ...
    if (idproducto == '' || descu == '' || canti == '' || pre == '' || descEquipo == '' || descProgra == '' ||
        idprogra == '' ||
