...
?>
<div class="container">
    <h2>Reporte de Devolución de Productos Requeridos en un Periodo</h2>
</div>
<br>
<form id="frm" name="frm" method="post" action="InvReportes.php">
    <div class="container">
    <p>Seleccione el periodo de las devoluciones:</p>
        <div class="row">
            ...
            <div class="col-md-3">
                <br>
                <input type="text" name="opcion" id="opcion" value="10" hidden>
                <input type="text" name="titulo" id="titulo" value="RELACIÓN DE DEVOLUCIONES DE PRODUCTOS REQUERIDOS EN UN PERIODO" hidden>
