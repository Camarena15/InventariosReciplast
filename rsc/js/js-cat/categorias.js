$(document).ready(function() {
    var IdCategoria, DescripcionC;
    opcion = 4;
        
    tabla = $('#tablaP').DataTable({  
        "ajax":{            
            "url": "bd/bd-cat/categoriascrud.php", 
    ...
    $('#formulario').submit(function(e){                         
        ...
        DescripcionC =$.trim($("#DescripcionC").val());                            
            $.ajax({
              ...
              type: "POST",
              datatype:"json",    
              data:  {IdCategoria:IdCategoria, DescripcionC:DescripcionC, opcion:opcion},    
    ...
    $("#btnNuevo").click(function(){
        ...
        $(".modal-title").text("Alta de Categorías");
    ...
    $(document).on("click", ".btnEditar", function(){		        
        ...
        DescripcionC = fila.find('td:eq(1)').text();
