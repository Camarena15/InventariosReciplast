$(document).ready(function() {
    var Id, IdEquipo, IdComponente, Descripcion;
    opcion = 4;
        
    tabla = $('#tablaP').DataTable({  
        "ajax":{            
            "url": "bd/bd-cat/componentescrud.php", 
    ...
    $('#formulario').submit(function(e){                         
        ...
        IdComponente =$.trim($("#IdComponente").val());  
        Descripcion =$.trim($("#Descripcion").val());                            
            $.ajax({
              url: "bd/bd-cat/componentescrud.php",
              type: "POST",
              datatype:"json",    
              data:  {Id:Id, Descripcion:Descripcion, opcion:opcion},    
    ...
    $(document).on("click", ".btnEditar", function(){		        
        ...
        IdComponente = parseInt(fila.find('td:eq(2)').text());
