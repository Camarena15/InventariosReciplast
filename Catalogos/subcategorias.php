    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <label>Categoría: <select name="" class="form-control" id="IdCategoria">
                        ...
                        <?php foreach ($data as $opciones): ?>
                            ...
                            <option value ="<?php echo $opciones['IdCategoria'] ?>"><?php echo $opciones['Descripcion'] ?></option>
                        
                        <?php endforeach ?>
                        </select> </label>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-form-label">SubCategoría: </label>
                            <input type="text" class="form-control" id="IdSubCategoria">
                        </div>
                        <div class="form-group">
