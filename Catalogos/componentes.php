...
<div class="container"><h1>Catálogo de Componentes</h1></div>
<div class="container">
        <div class="row">
            <div class="col-lg-12">            
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="" class="col-form-label">Id Componente: </label>
                            <input type="number" class="form-control" id="IdComponente">
                        </div>
                        <div class="form-group">
