...
?>
<div class="container">
    <h2>Reporte de Compras de Productos en un Periodo</h2>
</div>
<br>
<form id="frm" name="frm" method="post" action="InvReportes.php">
    ...
    <p>Seleccione el periodo de las compras:</p>
        <div class="row">
            ...
            <div class="col-md-3">
                <br>
                <input type="text" name="opcion" id="opcion" value="6" hidden>
                <input type="text" name="titulo" id="titulo" value="RELACIÓN DE COMPRAS DE PRODUCTOS EN UN PERIODO" hidden>
